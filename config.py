...
cfg = {
    ...
    "dataloader": {
        ...
        # whether to remove mean value into zero
        "mean_zero": True,
...
task_cfg = {
    ...
    "scd_classification": {
        "dataloader": {
            "task": "scd_classification_resnet18",
            "leads": ['I', 'II', 'III', 'aVR', 'aVL', 'aVF',
              'V1', 'V2', 'V3', 'V4', 'V5', 'V6'],
            "waveforms_file": "/home/ngsci/Final Project/data/ECG_waveform.npy",
            "label_file": "/home/ngsci/Final Project/data/scd_label.csv",
            "label_keys": ["scd"],
        },
    },
